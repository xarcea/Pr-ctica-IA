...
export class TreeVisualizationComponent {
  ...
  coordinatesArray: any[] = [
    { x: 10, y: "A", z: 1 }, { x: 10, y: "B", z: 0 }, { x: 9, y: "B", z: 0 },
    { x: 8, y: "B", z: 0 }, { x: 7, y: "B", z: 0 }, { x: 7, y: "C", z: 0 },
    { x: 7, y: "D", z: 0 }, { x: 6, y: "D", z: 0 }, { x: 5, y: "D", z: 0 },
    { x: 4, y: "D", z: 0 }, { x: 3, y: "D", z: 0 }, { x: 2, y: "D", z: 0 },
    { x: 2, y: "E", z: 0 }, { x: 2, y: "D", z: 1 }, { x: 2, y: "C", z: 0 },
    { x: 2, y: "B", z: 0 }, { x: 3, y: "B", z: 0 }, { x: 2, y: "D", z: 1 },
    { x: 4, y: "D", z: 1 }, { x: 4, y: "E", z: 0 }, { x: 4, y: "F", z: 0 },
    { x: 5, y: "F", z: 0 }, { x: 4, y: "F", z: 1 }, { x: 4, y: "G", z: 0 },
    { x: 3, y: "G", z: 0 }, { x: 2, y: "G", z: 0 }, { x: 2, y: "H", z: 0 },
    { x: 2, y: "I", z: 0 }, { x: 1, y: "I", z: 0 }, { x: 2, y: "I", z: 1 },
    { x: 3, y: "I", z: 0 }, { x: 4, y: "I", z: 0 }, { x: 5, y: "I", z: 0 },
    { x: 6, y: "I", z: 0 }, { x: 7, y: "I", z: 0 }
  ];
  ...
  buildTree() {
    ...
    this.tree = this.coordinatesArray.reduce((accumulator: TreeNode[], coordenada) => {
      if (coordenada.z === 1) {
        if (nodoMarcado) {
  ...
  iniciar() {
    ...
    const rootNodeData = { coordenada: { x: 0, y: 'Root', z: 0 }, marcado: true, hijo: this.tree };
    const rootNode: HierarchyNode<TreeNode> = d3.hierarchy<TreeNode>(rootNodeData);
